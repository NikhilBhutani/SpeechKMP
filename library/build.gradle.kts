...
kotlin {
    ...
    targets.withType<org.jetbrains.kotlin.gradle.plugin.mpp.KotlinNativeTarget> {
        binaries.framework {
            ...
            freeCompilerArgs += listOf("-Xbinary=bundleId=com.speechkmp.library")
    ...
    listOf(
        ...
        arch.compilations.getByName("main").cinterops {
            create("speech") {
                ...
                packageName("com.speechkmp.native")
...
publishing {
    publications.withType<MavenPublication>().configureEach {
        pom {
            ...
            url.set("https://github.com/example/speechkmp")
            licenses {
                license {
                    name.set("MIT")
            ...
            scm {
                url.set("https://github.com/example/speechkmp")
                connection.set("scm:git:git://github.com/example/speechkmp.git")
                developerConnection.set("scm:git:ssh://github.com/example/speechkmp.git")
            }
        }
    }
}
